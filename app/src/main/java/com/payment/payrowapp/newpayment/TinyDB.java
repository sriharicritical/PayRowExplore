...
public class TinyDB {
    ...
    public ArrayList<ContactlessConfiguration> getListConfig(String key, Class<ContactlessConfiguration> mClass) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ContactlessConfiguration> objects = new ArrayList<ContactlessConfiguration>();

        for (String jObjString : objStrings) {
            ContactlessConfiguration value = gson.fromJson(jObjString, mClass);
            objects.add(value);
        }
        return objects;
    }
...
//    }
    ...
    public void putConfigListObject(String key, ArrayList<ContactlessConfiguration> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (ContactlessConfiguration obj : objArray) {
            objStrings.add(gson.toJson(obj));
        }
        putListString(key, objStrings);
    }
